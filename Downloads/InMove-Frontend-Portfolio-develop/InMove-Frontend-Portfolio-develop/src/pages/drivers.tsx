      ...
      <main className="pt-32 pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-24">
            ...
            <div className="bg-muted rounded-3xl p-8 border-2 border-primary/10 relative overflow-hidden">
              <div className="aspect-video bg-background rounded-xl shadow-2xl flex items-center justify-center border border-border">
                 <div className="text-center p-6">
                    ...
                    <p className="font-medium">Simulação do Tablet no Carro</p>
          ...
          <div className="mb-24 grid gap-8 rounded-3xl border border-border bg-card p-8 md:grid-cols-2">
            <div>
              <h3 className="text-2xl font-display font-bold">Requisitos para participar</h3>
              <ul className="mt-4 space-y-3 text-muted-foreground">
                <li>• CNH válida e atividade regular em app de mobilidade.</li>
                <li>• Veículo em boas condições com tomada 12V ou USB.</li>
                <li>• Disponibilidade mínima de dias ativos por semana.</li>
                <li>• Aceite dos termos de instalação e manutenção do equipamento.</li>
              </ul>
            </div>
            <div>
              <h3 className="text-2xl font-display font-bold">Próximos passos</h3>
              <ol className="mt-4 space-y-3 text-muted-foreground">
                <li>1. Cadastro no WhatsApp com nome e cidade.</li>
                <li>2. Triagem rápida do perfil e rota.</li>
                <li>3. Agendamento de instalação sem custo.</li>
                <li>4. Início da operação com acompanhamento contínuo.</li>
              </ol>
            </div>
          </div>
          ...
          <div className="text-center">
            ...
            <button 
              onClick={() => {
                 trackEvent("click_drivers_cta_whatsapp");
