...
export function Showcase() {
  ...
  return (
    <section id="showcase" className="py-24 bg-card relative overflow-hidden">
                      ...
                      <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-6 pb-8">
                        <div className="flex items-end justify-between">
                          <div>
                            ...
                            <h3 className="text-white text-2xl font-bold mt-2">{img.title}</h3>
                          </div>
